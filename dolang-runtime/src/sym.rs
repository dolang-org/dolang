...
well_known_symbols! {
    ...
    (Clamp, "clamp", CLAMP),
    (IsNan, "is_nan", IS_NAN),
    (IsFinite, "is_finite", IS_FINITE),
    (IsInfinite, "is_infinite", IS_INFINITE),
    (IsNormal, "is_normal", IS_NORMAL),
    (IsSubnormal, "is_subnormal", IS_SUBNORMAL),
    (MinConst, "MIN", MIN_CONST),
    (MaxConst, "MAX", MAX_CONST),
    (EpsilonConst, "EPSILON", EPSILON_CONST),
    (InfConst, "INF", INF_CONST),
    (NanConst, "NAN", NAN_CONST),
    ...
    (Prechomp, "prechomp", PRECHOMP),
    (Precrimp, "precrimp", PRECRIMP),
    (Put, "put", PUT),
    ...
    (Field, "field", FIELD),
    (FieldThunk, "field_thunk", FIELD_THUNK),
    (ClassField, "class_field", CLASS_FIELD),
    (ClassFieldThunk, "class_field_thunk", CLASS_FIELD_THUNK),
    (StaticField, "static_field", STATIC_FIELD),
    (Fold, "fold", FOLD),
