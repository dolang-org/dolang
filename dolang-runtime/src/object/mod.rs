...
pub(crate) struct BuiltinTypes<'v> {
    ...
    pub(crate) stream_iter: TypeHandle<'v, strand::StreamIter<'v>>,
    pub(crate) stream_sink: TypeHandle<'v, strand::StreamSink<'v>>,
    ...
    pub(crate) str_view: TypeHandle<'v, str::View<'v>>,
    pub(crate) str_view_iter: TypeHandle<'v, str::ViewIter<'v>>,
    ...
    pub(crate) class_type_proxy: TypeHandle<'v, class::ClassTypeProxy<'v>>,
    pub(crate) class_instance: TypeHandle<'v, class::ClassInstance<'v>>,
    pub(crate) getter: TypeHandle<'v, class::Getter>,
    pub(crate) setter: TypeHandle<'v, class::Setter>,
    ...
    pub(crate) null_type: TypeHandle<'v, iter::NullType>,
    pub(crate) chain_iter: TypeHandle<'v, iter::Chain<'v>>,
    pub(crate) zip_iter: TypeHandle<'v, iter::Zip<'v>>,
    pub(crate) take_iter: TypeHandle<'v, iter::Take<'v>>,
    pub(crate) skip_iter: TypeHandle<'v, iter::Skip<'v>>,
    pub(crate) enumerate_iter: TypeHandle<'v, iter::Enumerate<'v>>,
    pub(crate) kv_iter: TypeHandle<'v, iter::Kv<'v>>,
    pub(crate) map_iter: TypeHandle<'v, iter::Map<'v>>,
    pub(crate) filter_iter: TypeHandle<'v, iter::Filter<'v>>,
    pub(crate) premap_iter: TypeHandle<'v, iter::Premap<'v>>,
    pub(crate) prefilter_iter: TypeHandle<'v, iter::Prefilter<'v>>,
    pub(crate) chomp_iter: TypeHandle<'v, iter::Chomp<'v>>,
    pub(crate) prechomp_iter: TypeHandle<'v, iter::Prechomp<'v>>,
    pub(crate) crimp_iter: TypeHandle<'v, iter::Crimp<'v>>,
    pub(crate) precrimp_iter: TypeHandle<'v, iter::Precrimp<'v>>,
    ...
    pub(crate) array_view_type: TypeHandle<'v, array_view::Type>,
    pub(crate) dict_view_type: TypeHandle<'v, dict_view::Type>,
...
impl<'v> BuiltinTypes<'v> {
    pub(crate) fn new(types: &mut TypeTable<'v>) -> Self {
        Self {
            ...
            class_type_proxy: types.register_type_handle(),
            class_instance: types.register_type_handle(),
            getter: types.register_type_handle(),
            setter: types.register_type_handle(),
            ...
            stream_iter: types.register_type_handle(),
            stream_sink: types.register_type_handle(),
            ...
            verbatim_int: types.register_type_handle(),
            ...
            array_view_type: types.register_type_handle(),
            dict_view_type: types.register_type_handle(),
            ...
            null_type: types.register_type_handle(),
            chain_iter: types.register_type_handle(),
            zip_iter: types.register_type_handle(),
            take_iter: types.register_type_handle(),
            skip_iter: types.register_type_handle(),
            enumerate_iter: types.register_type_handle(),
            kv_iter: types.register_type_handle(),
            map_iter: types.register_type_handle(),
            filter_iter: types.register_type_handle(),
            premap_iter: types.register_type_handle(),
            prefilter_iter: types.register_type_handle(),
            chomp_iter: types.register_type_handle(),
            prechomp_iter: types.register_type_handle(),
            crimp_iter: types.register_type_handle(),
            precrimp_iter: types.register_type_handle(),
...
pub(crate) struct Singletons<'v> {
    ...
    pub(crate) null: Value<'v>,
    pub(crate) null_type: Value<'v>,
    ...
    pub(crate) array_view: Value<'v>,
    pub(crate) dict_view: Value<'v>,
...
impl<'v> Singletons<'v> {
    pub(crate) fn new(
        ...
        Self {
            ...
            null: v!(builtin_types.null, iter::Null),
            null_type: v!(builtin_types.null_type, iter::NullType),
            ...
            array_view: v!(builtin_types.array_view_type, array_view::Type),
            dict_view: v!(builtin_types.dict_view_type, dict_view::Type),
