...
pub(crate) struct BuiltinTypes<'v> {
    ...
    pub(crate) descriptor: TypeHandle<'v, class::Descriptor>,
...
impl<'v> BuiltinTypes<'v> {
    pub(crate) fn new(types: &mut TypeTable<'v>) -> Self {
        Self {
            ...
            descriptor: types.register_type_handle(),
...
impl<'v> Singletons<'v> {
    pub(crate) fn new(
        ...
        Self {
            ...
            descriptor: v!(builtin_types.descriptor, class::Descriptor),
